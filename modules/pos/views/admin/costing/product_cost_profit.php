                            ...
                            <table class="table table-bordered table-striped table-hover" id="product-cost-profit-table">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="sortable" style="width:120px;" data-sort="margin">Profit Margin (%) <i class="fa fa-sort"></i></th>
                                ...
                                <tbody>
                                    ...
                                    <tr class="product-row"
                                        ...
                                        <td>
                                            ...
                                            <button class="btn btn-info btn-sm" onclick="openSimulator(<?php echo (int)$item['id']; ?>, 'normal')" data-toggle="tooltip" title="Mix and match this product's modifiers to see the resulting cost/profit">
...
<div class="modal fade" id="simulatorModal" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h4 class="modal-title">Cost Profit Simulator — <span id="simulator-item-name">-</span></h4>
                <p class="text-muted small no-margin-bottom">Read-only. Pick modifiers the way a customer would at POS and see the resulting cost/profit for that exact combination.</p>
            </div>
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12">
...
function openSimulator(itemId, mode) {
    ...
    simulatorState.mode = mode || 'normal';
...
$(document).on('change', '.simulator-option', function () {
    ...
    if (!isMulti) {
        // Radio-style group: only one selected key per group.
