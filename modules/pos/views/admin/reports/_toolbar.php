...
<ul class="nav nav-tabs" style="margin-bottom:18px;">
    ...
    <li class="<?php echo $active_tab === 'shifts'     ? 'active' : ''; ?>"><a href="<?php echo admin_url('pos/reports/shifts'); ?>">Staff &amp; Shifts</a></li>
    <li class="<?php echo $active_tab === 'customers'  ? 'active' : ''; ?>"><a href="<?php echo admin_url('pos/reports/customers'); ?>">Customers</a></li>
    <li class="<?php echo $active_tab === 'promotions' ? 'active' : ''; ?>"><a href="<?php echo admin_url('pos/reports/promotions'); ?>">Promotions</a></li>
</ul>
