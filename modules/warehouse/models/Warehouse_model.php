...
class Warehouse_model extends App_Model {
	 ...
	 */
        ...
        public function get_api_goods_transaction_history(array $filters, ?int $limit, int $offset)
        {
                ...
                $this->db->select([
                        ...
                        db_prefix() . 'items.sku_code as goods_receipt_commodity_code',
                        db_prefix() . 'items.sku_name as commodity_name',
	...
	public function get_loss_adjustment($id = '') {
		...
		$this->db->join(
			db_prefix() . 'warehouse',
			db_prefix() . 'warehouse.warehouse_id = ' . db_prefix() . 'wh_loss_adjustment.warehouses',
			'left'
		);
		if ($id == '') {
