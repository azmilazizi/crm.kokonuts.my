...
- Remove files with `DELETE /purchase/api/v1/purchase_order_drafts/{id}/attachments` by passing an `ids` array. Draft updates no longer trigger attachment deletions.
