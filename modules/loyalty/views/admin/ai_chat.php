...
<div id="ai-wrap">
    ...
    <div id="ai-header">
        <div class="ai-title">
            ...
            AI Assistant
            <small class="text-muted" style="font-weight:400;font-size:12px;">Gemini 2.0 Flash</small>
        </div>
    ...
    <div id="ai-input-area">
        <div class="input-row">
            <textarea id="ai-input" rows="1" placeholder="Ask anything about your sales, members, or promotions…"></textarea>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <input type="password" id="s-api-key" class="form-control" placeholder="AIza…"
                           value="<?php echo htmlspecialchars($gemini_key); ?>">
                    <p class="help-block">Get a free key at <strong>aistudio.google.com</strong> → Get API key. Use Gemini 2.0 Flash.</p>
                </div>
            </div>
...
function sendMessage() {
    ...
    $.post(ADMIN_URL + 'loyalty/ajax_ai_chat', {
        message: msg,
        history: JSON.stringify(_history.slice(0, -1)), // exclude current turn (already in message)
        context: ctx
    })
    .done(function(resp) {
...
function saveSettings() {
    ...
    $.post(ADMIN_URL + 'loyalty/ajax_save_ai_settings', { gemini_api_key: key })
    .done(function(resp) {
        if (typeof resp === 'string') { try { resp = JSON.parse(resp); } catch(e){} }
        if (resp && resp.success) {
            HAS_KEY = !!key;
