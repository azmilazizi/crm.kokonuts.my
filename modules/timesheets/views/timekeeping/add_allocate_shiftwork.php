...
if(isset($word_shift)){
  ...
  $department = ($word_shift->department != null ? explode(',', $word_shift->department) : []);
  $position = ($word_shift->position != null ? explode(',', $word_shift->position) : []);
  $add_from = $word_shift->add_from;

  $staff = ($word_shift->staff != null ? explode(',', $word_shift->staff) : []);
